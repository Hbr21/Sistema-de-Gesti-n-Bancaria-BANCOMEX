...
public class PracticaCajero extends JFrame {
    ...
    private JButton btnDeposito, btnRetiro;
...
com.itextpdf.text.Font normal = new com.itextpdf.text.Font(com.itextpdf.text.Font.FontFamily.HELVETICA, 12);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new PracticaCajero().setVisible(true));
    }
}
